...
export default function PreviewCode({ item }: { item: FileItem }) {
  ...
  return (
    <div className="flex-1 overflow-auto p-4 bg-nord0" style={{ minHeight: 0 }}>
      <pre className="text-nord6 leading-relaxed" style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '11.5px' }}>
        <code>{content}</code>
      </pre>
    </div>
  )
